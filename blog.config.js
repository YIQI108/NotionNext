...
const BLOG = {
  ...
  AUTHOR: process.env.NEXT_PUBLIC_AUTHOR || '艺绮', // 您的昵称 例如 YIQI
  BIO: process.env.NEXT_PUBLIC_BIO || 'AI摄影工作室', // 作者简介
  LINK: process.env.NEXT_PUBLIC_LINK || 'https://tangly1024.com', // 网站地址
  KEYWORDS: process.env.NEXT_PUBLIC_KEYWORD || '摄影,AI,新媒体', // 网站关键词 英文逗号隔开

  // 社交链接，不需要可留空白，例如 CONTACT_WEIBO:''
  CONTACT_EMAIL: process.env.NEXT_PUBLIC_CONTACT_EMAIL || '3819182418@qq.com', // 邮箱地址 例如mail@tangly1024.com
